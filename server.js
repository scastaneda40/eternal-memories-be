...
const signInUser = require('./routes/sign_in_user');
app.post('/auth/signin', signInUser);

const signUpUserRoutes = require('./routes/sign_up_user'); // Import router
app.use('/auth', signUpUserRoutes); // Mount router
